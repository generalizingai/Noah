...
class AIAgent:
    ...
    def _tool_label(name: str) -> str:
        ...
        labels = {
            ...
            "computer_open_application": "Opening app…",
            "computer_click": "Clicking on screen…",
            "computer_type": "Typing…",
            "computer_hotkey": "Pressing shortcut…",
            "computer_wait_for_app": "Waiting for app…",
            "computer_claude_create_thread": "Creating Claude thread…",
            "computer_observe": "Observing screen state…",
            "computer_click_text": "Finding and clicking element…",
            "computer_type_in_field": "Filling field…",
            "computer_verify_text": "Verifying result…",
