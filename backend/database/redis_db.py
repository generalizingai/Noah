...
def _parse_redis_host_port() -> tuple[str, int]:
    ...
    if ':' in raw:
        ...
        try:
            ...
            pass
    env_port = os.getenv('REDIS_DB_PORT')
    return raw, int(env_port) if env_port else 6379


_redis_host, _redis_port = _parse_redis_host_port()
