...
_TYPESENSE_API_KEY = os.getenv('TYPESENSE_API_KEY') or 'placeholder'
_TYPESENSE_HOST = os.getenv('TYPESENSE_HOST') or 'localhost'
_TYPESENSE_PORT = os.getenv('TYPESENSE_HOST_PORT') or '443'
