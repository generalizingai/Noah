"""
Tools for answering questions about the Noah product.
"""
...
@tool
def get_noah_product_info_tool(query: str) -> str:
    """
    Get information about the Noah product to answer questions about features, functionality, setup, or purchasing.
    ...
    Args:
        query: The specific question about Noah product (e.g., "How does the device connect to my phone?", "What is the battery life?")
    ...
    context_str = 'Noah Product Documentation:\n\n'
    for section, content in context.items():
        context_str += f'## {section}\n\n{content}\n\n'

    context_str += (
        '\n\nUse this documentation to answer questions about the Noah product, its features, setup, and usage.'
    )
