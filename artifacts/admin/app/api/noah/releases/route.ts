...
const GITHUB_REPO = 'BasedHardware/noah';
...
async function fetchGithubReleases(): Prnoahse<any[]> {
...
async function posthogQuery(query: string): Prnoahse<any> {
...
async function fetchPostHogMetrics(
  versions: string[]
): Prnoahse<Map<string, VersionMetrics>> {
