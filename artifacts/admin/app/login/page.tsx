      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <Card className="w-full max-w-sm mx-4">
          <CardHeader className="text-center">
            <p className="text-3xl font-bold tracking-tight mb-1">Noah</p>
            <CardTitle className="text-lg font-medium text-muted-foreground">Admin Dashboard</CardTitle>
            <CardDescription className="pt-1">Sign in using your authorized Google account.</CardDescription>
          </CardHeader>
          <CardContent>
