...
import { CompactPluginCard } from './CompactPluginCard';

interface SearchBarProps {
  className?: string;
  allApps: Plugin[];
  onSearching?: (searching: boolean) => void;
  onResults?: (results: Plugin[]) => void;
}

export function SearchBar({ className, allApps, onSearching, onResults }: SearchBarProps) {
